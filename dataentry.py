...
db_session.commit()
test_tutor = Tutor("Test", "Test", "Junior", "(650)-245-9977", "colin.ho@menloschool.org", db_session.query(User.id).where(User.name == "colin").first()[0])
test_tutor2 = Tutor("Test", "Test", "Junior", "911", "gakle.horch@menloschool.org", db_session.query(User.id).where(User.name == "galen").first()[0])
